...
def run_visualization(url):
  ...
  resized_im, seg_map = MODEL.run(Image.open(url))

  return seg_map


path = os.path.dirname(os.path.abspath(__file__))
seg_map = run_visualization(os.path.join(path, 'ya0hconOiKg.jpg'))
Image.fromarray((255*seg_map/seg_map.max()).astype('uint8')).save('map.jpg')
